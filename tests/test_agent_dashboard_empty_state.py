...
def _install_import_stubs():
    model_names = (
        "DBAIDraft", "DBAgentMessageRoute", "DBAgentProfile", "DBBrokerage",
        "DBBrokerageBuyerProfile", "DBBrokerageMember", "DBBuyerSuppression",
        "DBCampaign", "DBCampaignRecipient", "DBCampaignUpload", "DBConversation",
        "DBDraftReply", "DBLeadAction", "DBLeadAssignment", "DBLeadTask",
        "DBMarketingEvent", "DBMarketingPage", "DBMessage", "DBEscalationThread",
        "DBEscalationThreadQuestion", "DBListing", "DBOfferRecord", "DBOwnerLead",
        "DBOutreachDraft", "DBViewing",
    )
    stubs = {
        "fastapi": _module(
            "fastapi",
        ...
        "app.core.intent_rules": _module("app.core.intent_rules", detect_intent_rules=lambda *args, **kwargs: {}),
