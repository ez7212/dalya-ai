...
```json
{
  "invocation": "cd frontend && node scripts/verify-next-mvp-final-surface.mjs --fixture-frontend-root <ENV:FIXTURE_FRONTEND_ROOT> --base-url http://127.0.0.1:3999 --output-dir ../.omo/evidence/task-3-final-surface-red-env-production-local",
