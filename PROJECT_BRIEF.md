...
| [`docs/domain/dubai-real-estate-verified-facts.md`](./docs/domain/dubai-real-estate-verified-facts.md) · [`docs/domain/dubai-real-estate-facts-to-verify.md`](./docs/domain/dubai-real-estate-facts-to-verify.md) | Verified Dubai facts register (awaiting Eric) + the verification checklist — exact regulatory/fee/process claims route through here before the bot may state them |
